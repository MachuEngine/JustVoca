...
export const updateUserProfile = (uid: string, profileData: any) => api.put(`/user/${uid}/profile`, profileData);
export const updateStudySettings = (uid: string, settingsData: any) => api.put(`/user/${uid}/settings`, settingsData);
